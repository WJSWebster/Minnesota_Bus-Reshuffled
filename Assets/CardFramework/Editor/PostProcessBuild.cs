...
public class PostProcessBuild 
{
	...
	static public void Process(BuildTarget target, string pathToBuiltProject) 
	{
        ...
        else if (/*target == BuildTarget.StandaloneOSXIntel || target == BuildTarget.StandaloneOSXIntel64 ||*/ target == BuildTarget.StandaloneOSX) //BuildTarget.StandaloneOSXUniversal)
